...
class FrontPageController extends Controller
{
    ...
    public function index()
    {
        ...
        if($conditional_host[0] =='Mobi-super-bidding-docs'){
        ...
        if($conditional_host[0] =='Mobi-super-server'){

        return view('admin.login');

        }
        if($conditional_host[0] =='Mobi-super-bidding'){
        ...
        if($conditional_host[0] =='Mobi-super-bidding-dispatcher'){
        ...
        if($conditional_host[0] =='Mobi-super-bidding-delivery-dispatcher'){
...
/*taxi*/
        if($conditional_host[0] =='Mobi-docs'){

        return redirect('user-manual');

        }

        if($conditional_host[0] =='Mobi-server'){
        ...
        if($conditional_host[0] =='Mobi-web-booking'){
        ...
        if($conditional_host[0] =='Mobi-dispatch'){
...
/*delivery*/
        if($conditional_host[0] =='delivery-docs'||$conditional_host[0] =='Mobi-delivery-docs'){

            return redirect('user-manual');

        }

        if($conditional_host[0] =='Mobi-delivery'||$conditional_host[0] =='delivery'){
        ...
        if($conditional_host[0] =='Mobi-delivery-dispatch'||$conditional_host[0] =='delivery-dispatch'){
...
/*super-app*/
        if($conditional_host[0] =='Mobi-super-docs'){
        ...
        if($conditional_host[0] =='Mobi-super-dispatcher'){
