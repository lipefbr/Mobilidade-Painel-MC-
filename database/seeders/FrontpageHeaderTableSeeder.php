    ...
    public function run()
    {
        ...
        \DB::table('landingpagecms')->insert(array (
            ...
            array (
                'id' => 19,
                'userid' => 1,
                'tabfaviconfile'=>'logo.png',
                'faviconfile' => 'logo.png',
...
Download the Mobi app Today</strong></h2>',
...
<h2><strong>Carolina</strong></h2>',
                'footertextsub' => '<p>Mobi is a rideshare platform facilitating peer to peer ridesharing by means of connecting passengers who are in need of rides from drivers with available cars to get from point A to point B with the press of a button.</p>',
                'footercopytextsub' => '<p>&copy; 2021 Mobi, LLC All rights reserved. <a href="http://localhost/taxiwebnew/index.php#" target="blank"> Powered By Mobi </a></p>',
                'footerlogo'=>'logo.png',
...
<li>North Carolina vehicle inspection</li>
                    ...
                    'afrhtext' => '<h1><strong>Download the Driver Mobi app Today</strong></h1>',
...
<h3>Hours are completely flexible. Drive mornings, evenings, weekdays, or weekends.</h3>',
                    ...
                    'asrstext1' => '<p>Download the Mobi Driver App from the Google Play or App Store on your smartphone.</p>',
...
General Inquiries: <a href="mailto:info@tyt.us"> info@tyt.us</a></p>',                    
                    ...
                    'driverioslink' => 'https://apps.apple.com/in/app/Mobi-driver/id1608868990',
                    'driverandroidlink' => 'https://play.google.com/store/apps/details?id=com.Mobi.operator"',
                    'userioslink' => 'https://apps.apple.com/in/app/Mobi/id1608868419',
                    'userandroidlink' => 'https://play.google.com/store/apps/details?id=com.Mobi.user',    
                    'menucolor'=>'#ffffff',
                    'menutextcolor'=>'#111',
                    'menutexthover'=>'#111',
                    'firstrowbgcolor'=>'#5cd7b1',
                    'hdriverdownloadcolor'=>'#111',
                    'hownumberbgcolor'=>'#31c1df',
                    'footerbgcolor'=>'#4f4f4f',
