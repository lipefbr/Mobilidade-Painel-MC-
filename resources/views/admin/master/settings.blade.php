                                            ...
                                            <div class="file-tab panel-body"> --}}
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-6 img_remove">
                                                              ...
                                                              <button class="btn btn-primary btn-sm" type="button" onclick="$({{ $setting_name['name'] }}).click()" id="upload">@lang('view_pages.browse')</button> <span><a href="https://Mobi-docs.ondemandappz.com/user-manual/1.0/backend-setup#section-5" target="_blank" style="  text-decoration: underline;">How do i get the Firebase Json File?</a></span>
                                                                  <?php
                                                              }else{ ?>
