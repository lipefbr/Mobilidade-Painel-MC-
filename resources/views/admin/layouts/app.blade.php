...
<head>
    ...
    <title>{{ app_name() ?? 'Mobi' }} - Admin App</title>
                    ...
                    <div class="modal-content" style="padding: 10px;">
                        ...
                        <div class="modal-body " style="text-align: center;padding: 26px;">
                            <a id="sos-nav" data-url="">
                                <button type="button" class="btn btn-primary"  aria-haspopup="true" aria-expanded="false" style="padding: 11px;font-size: 13px;">Clique para ver</button>
                            </a>
                            <div>
                            </div>
                        </div>
