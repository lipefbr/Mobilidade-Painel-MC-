...
@else
    @php $image = asset('assets/images/'); @endphp
@endif
    <style>
        .error-style {
            list-style: none;
            ...
            <div class="col-lg-4 col-md-8 col-12">
                <div class="login-box">
                    <div class="login-box-body text-center" style="border-radius:20px;border: 1px solid #d1cfcf;">
                        ...
                        <h3 class="text-center">Painel Admin</h3>
                           ...
                           <span class="ion ion-locked form-control-feedback"></span>
                                ...
                                <div class="col-md-11 mx-auto text-center p-0 login-email">
                                    <input type="password" name="password" style="border-radius:none;" required=""
                                        id="password" class="form-control rounded" placeholder="Senha" maxlength="30"
                            ...
                            <div class="col-md-11 mx-auto text-center p-0">
                                <div class="col-6">
                                    <div class="checkbox">
                                        ...
                                        <label for="basic_checkbox_1">Lembrar do login?</label>
                                    </div>
                                </div>
